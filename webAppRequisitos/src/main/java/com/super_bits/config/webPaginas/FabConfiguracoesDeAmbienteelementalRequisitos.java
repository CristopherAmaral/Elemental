...
import com.super_bits.GAME_SUPERBITS_ELEMENTAL.elemental.model.config.ConfigPersistenciaelemental;
import com.super_bits.GAME_SUPERBITS_ELEMENTAL.elemental.regras_de_negocio_e_controller.MODULOS.demonstracao_acesso_restrito.FabAcaoAcessoRestritoExemplo;
 ...
 */
public enum FabConfiguracoesDeAmbienteelementalRequisitos {
    ...
    public ItfConfigSBPersistencia getConfiguracaoPersistencia() {
        return new ConfigPersistenciaelemental();
    }

    public ItfConfigWebPagina getConfiguracaoWebPaginas() {
        return new ConfigWPelemental();
    }
