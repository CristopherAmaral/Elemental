 ...
 */
package com.super_bits.GAME_SUPERBITS_ELEMENTAL.elemental.configAppp;

import com.super_bits.modulosSB.Persistencia.ConfigGeral.SBPersistencia;
import com.super_bits.modulosSB.Persistencia.ERROS.TesteJunitSBPersistencia;
import com.super_bits.modulosSB.SBCore.ConfigGeral.SBCore;
import com.suwper_bits.configSBFW.FabConfiguracoesSBModelelemental;
...
public class TesteProjetoExemplo extends TesteJunitSBPersistencia {
    ...
    protected void configAmbienteDesevolvimento() {
        SBCore.configurar(FabConfiguracoesSBModelelemental.DESENVOLVIMENTO.getConfiguracao());
        SBPersistencia.configuraJPA(FabConfiguracoesSBModelelemental.DESENVOLVIMENTO.getConfiguracaoPersistencia());
    }
